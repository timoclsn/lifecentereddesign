        ...
        <Stack space="48px">
          ...
          <Stack space="32px">
            <Text as="p">
              ...
              designing interactive systems that places the users and their
              needs in the center of the design process. It has been around for
              ages now, first gaining popularity in 1986 through the book
            ...
            <Text as="p">
              With that very same attitude, several questions can be posed: Is
              it enough to focus the design around human stakeholders? Are we
              the only ones affected by our products? What about long-term
              effects – are we considering them as well? Or effects that are
              more indirect and might be hidden under the surface of short-term
              user needs?
            </Text>
            <Text as="p">
              ...
              practices for a life-centered approach. Nevertheless, the
              questions posed above seek to be answered. And life-centered
              design is (at least for me) a term that fits well enough to drive
              the conversation around these questions further.
            </Text>
            <Text as="p">
              That is why I want to create Life Centered Design.Net. It is
              supposed to be a home for information, resources, and
              conversations to evolve beyond human-centered and user experience
              design.
            </Text>
          </Stack>
        </Stack>
