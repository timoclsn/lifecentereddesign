    ...
    <section id="about-us" className="mx-auto max-w-3xl space-y-20">
      <div>
        ...
        <div className="space-y-4 text-dark">
          ...
          <p>
            This is <strong>Katharina</strong>. My husband <strong>Timo</strong>{' '}
            and I are the two people behind Life Centered Design.Net.
          </p>
          <p>
            I have developed a passion for the mindset I associate with
            life-centered design. I am trying to weave in parts of this mindset
            into the things I do as <strong>Head of Strategy & UX</strong> at{' '}
            <a
          ...
          <p>
            Because of my deep interest in that topic but also due to the fact,
            that it was very hard for me to find information and best practices
            on life-centered design in the past years, I wanted to create Life
            Centered Design.Net
          </p>
        </div>
      </div>
